<?
	if(isset($_GET['gentre'])){
		$data = mysql_query('SELECT * FROM songs WHERE gentre_id='.$_GET['gentre'].'');
		$check =mysql_fetch_assoc(mysql_query('SELECT COUNT(*) FROM songs WHERE gentre_id='.$_GET['gentre'].'')); 
		if($check['COUNT(*)']!=0){
